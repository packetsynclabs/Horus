...
// Major: GDT with K/U segments + TSS (esp0 updated on context switch)
// Note: Still using legacy 32-bit GDT entry format. Full 64-bit GDT rewrite is part of the ongoing transition.
void gdt_init(void) {
...
// Major: live update of TSS.esp0 for current task's kernel stack
